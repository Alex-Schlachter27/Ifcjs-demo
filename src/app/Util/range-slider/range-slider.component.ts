...
export class RangeSliderComponent implements OnChanges{
    ...
    private buildCallback(): IonRangeSliderCallback {
        ...
        callback.from_percent = this.from_percent as number;
        callback.from_value = this.from_value as number;
        callback.to = this.to;
        callback.to_percent = this.to_percent as number;
        callback.to_value = this.to_value as number;
        return callback;
    }
}
